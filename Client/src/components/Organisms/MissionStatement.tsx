  ...
  return (
    <section className="flex flex-col gap-10 items-center py-12">
      <div className="max-w-2xl text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-2">{t("aboutPage.missionSection.missionTitle")}</h2>
        <p className="text-lg text-muted-foreground mb-4">{mission}</p>
        <h3 className="text-xl font-semibold mb-2">{t("aboutPage.missionSection.visionTitle")}</h3>
